...
export const LAUNCH_CATEGORIES = [
  ...
  "process-fingerprint",
  // The RSS backstop's post-mortem memory attribution (memory-report.ts):
  // `footprint`/`vmmap` on the death path, once per breach, never per render.
  "limits.memory-report",
